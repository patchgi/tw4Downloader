...
<html lang="en">
<head>
    <title>Code coverage report for cheerio-httpcli/lib/cheerio-extend.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">cheerio-httpcli/lib/</a> cheerio-extend.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    if (method === 'GET') {
      var join = (url.indexOf('?') === -1) ? '?' : <span class="branch-1 cbranch-no" title="branch not covered" >'&amp;';</span>
      if (formParamStr.length &gt; 0) {
