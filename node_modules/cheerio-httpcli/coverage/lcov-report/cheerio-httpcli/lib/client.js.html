...
<html lang="en">
<head>
    <title>Code coverage report for cheerio-httpcli/lib/client.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">cheerio-httpcli/lib/</a> client.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">119×</span>
<span class="cline-any cline-yes">938×</span>
<span class="cline-any cline-yes">2×</span>
<span class="cline-any cline-yes">2×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/*eslint key-spacing:0 no-undefined:0*/
'use strict';
&nbsp;
...
&nbsp;
  ...
  fail: function (err, options, extra, result, reject) {
    extra = extra || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
    result = result || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
    var error = (err instanceof Error) ? err : new Error(err);
    <span class="missing-if-branch" title="else path not taken" >E</span>if (options.param.uri) {
    ...
    Object.keys(extra).forEach(function (ex) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof extra[ex] !== 'undefined') {
        error[ex] = extra[ex];
      }
    });
&nbsp;
    ...
    if (options.callback instanceof Function) {
      ...
      Object.keys(result).forEach(function (r) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof result[r] !== 'undefined') {
          error[r] = result[r];
        }
      });
      reject(error);
...
&nbsp;
    // デバッグ情報
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.core.debug) {
...
<span class="cstat-no" title="statement not covered" >      [ 'uri', 'method', 'headers', 'qs', 'form' ].forEach(<span class="fstat-no" title="function not covered" >function (v) {</span></span>
<span class="cstat-no" title="statement not covered" >        if (param[v]) {</span>
<span class="cstat-no" title="statement not covered" >          debugParams[label][v] = param[v];</span>
        }
      });
<span class="cstat-no" title="statement not covered" >      var cookies = {};</span>
<span class="cstat-no" title="statement not covered" >      param.jar.getCookies(param.uri).forEach(<span class="fstat-no" title="function not covered" >function (c) {</span></span>
...
&nbsp;
      ...
      if (/^30\d$/.test(res.statusCode) &amp;&amp; res.headers.location) {
        retry = retry || 0;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (retry &gt; 5) {
<span class="cstat-no" title="statement not covered" >          return callback(new Error('redirect limit over'), res, body);</span>
        }
&nbsp;
        // パラメータの調整
...
&nbsp;
      ...
      if ((body || <span class="branch-1 cbranch-no" title="branch not covered" >[])</span>.length === 0) {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Fri Oct 23 2015 23:06:07 GMT+0900 (JST)
</div>
</div>
