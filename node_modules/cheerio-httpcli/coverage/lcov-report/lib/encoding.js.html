...
<html lang="en">
<head>
    <title>Code coverage report for lib/encoding.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">lib/</a> encoding.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/*eslint key-spacing:0, no-unused-expressions:0*/
...
<span class="branch-2 cbranch-no" title="branch not covered" >      case 'iso-2022-jp': {</span>
<span class="cstat-no" title="statement not covered" >        encodeFunc = EscapeJIS7;</span>
...
&nbsp;
  ...
  detectByBuffer: function (buffer) {
    ...
    // 高精度で判定できた場合のみ
    if (enc &amp;&amp; enc.encoding &amp;&amp; (enc.confidence || <span class="branch-1 cbranch-no" title="branch not covered" >0)</span> &gt;= 0.99) {
      return enc.encoding;
    }
    return null;
  },
&nbsp;
  ...
  detectByHeader: function (buffer) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (head) {
...
encoding.iconvLoad('iconv') || <span class="branch-1 cbranch-no" title="branch not covered" >encoding.iconvLoad('iconv-lite');</span>
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Thu Oct 29 2015 00:56:56 GMT+0900 (JST)
</div>
</div>
